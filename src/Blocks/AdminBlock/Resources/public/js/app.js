...
module.exports = {
    App: function(){
        ...
        return window.materialadmin.App = new App;
    },
    AppNavigation : function() {
        ...
        p.activateMenu = function(path){
            $('#main-menu li').removeClass('active');
            var p = path.substring(1);
            if(p.indexOf('/') > -1)p = p.substr(0, p.indexOf('/'));
            $('#'+p+'-menu').addClass('active');
            if($('#'+p+'-menu').parent().parent().is('li'))
                $('#'+p+'-menu').parent().parent().addClass('active');
        };
        return window.materialadmin.AppNavigation = new AppNavigation;
    },
    AppOffcanvas: function(){
        ...
        return window.materialadmin.AppOffcanvas = new AppOffcanvas;
    },
    AppCard: function(){
        ...
        return window.materialadmin.AppCard = new AppCard;
    },
    AppForm: function(){
        ...
        return window.materialadmin.AppForm = new AppForm;
    },
    AppNavSearch: function(){
        ...
        return window.materialadmin.AppNavSearch = new AppNavSearch;
    },
    AppVendor: function(){
        ...
        return window.materialadmin.AppVendor = new AppVendor;
    }
};
