    ...
    j = function(d) {
        ...
        e.prototype = {
            ...
            _fnDrawCallback: function() {
                for (var a = this.s.dt.aoColumns, b = this.dom.buttons, c = this.s.aoGroups, f, g = 0, h = b.length; g < h; g++) f = b[g], f.__columnIdx !== k && d("input", f).prop("checked", a[f.__columnIdx].bVisible);
                b = 0;
            ...
            _fnAddButtons: function() {
                ...
                if (-1 === d.inArray("all", this.s.aiExclude))
                    for (var c = 0, f = b.length; c < f; c++) - 1 === d.inArray(c, this.s.aiExclude) && (a = this._fnDomColumnButton(c), a.__columnIdx = c, this.dom.buttons.push(a));
            ...
            _fnDomColumnButton: function(a) {
                ...
                return d("<li " + (f.bJUI ? 'class="ui-button ui-state-default"' : "") + '><label><input type="checkbox" /><span>' + c + "</span></label></li>").click(function(c) {
                    ...
                    "input" === c.target.nodeName.toLowerCase() && null !== b.s.fnStateChange && b.s.fnStateChange.call(b, a, e)
                })[0]
            },
...
(function(m, k, p) {
        ...
        TableTools.prototype = {
            ...
            fnCalcColRatios: function(a) {
                var b = this.s.dt.aoColumns,
                    ...
                    f, i;
                f = 0;
                for (i = a.length; f < i; f++) a[f] && (d = b[f].nTh.offsetWidth, e += d, c.push(d));
                f = 0;
            ...
            _fnButtonDefinations: function(a, b) {
                for (var c, d = 0, e = a.length; d < e; d++) {
                    if ("string" == typeof a[d]) {
                        ...
                        c = f.extend(c, a[d], !0)
                    }(c = this._fnCreateButton(c, f(b).hasClass(this.classes.collection.container))) && b.appendChild(c)
                }
            },
            ...
            _fnCollectionShow: function(a, b) {
                ...
                d + o > h && (e.style.top = d - o - f(a).outerHeight() + "px");
                            ...
                            if (e.type == "os")
                                if (c.ctrlKey || c.metaKey) a.fnIsSelected(d) ? a._fnRowDeselect(d, c) : a._fnRowSelect(d, c);
                                    ...
                                    var i = a.s.dt.aiDisplay.slice(),
                                        ...
                                        o = f.inArray(j, i);
                                    if (a.fnGetSelected().length === 0 || h === -1) i.splice(f.inArray(j, i) + 1, i.length);
                                    else {
                                        if (h > o) var g = o,
                                            o = h,
                                            h = g;
    ...
    "function" === typeof define && define.amd ? define(["jquery", "datatables"], r) : "object" === typeof exports ? r(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.TableTools && r(jQuery, jQuery.fn.dataTable)
})(window, document);